...
function HomepageHeader() {
  ...
  var bgimg={'background': 'url(https://i.loli.net/2021/11/02/VcswqIO6Ttdn7DS.jpg) no-repeat','background-size': 'cover','background-repeat': 'no-repeat','background-position': 'center 0'};
